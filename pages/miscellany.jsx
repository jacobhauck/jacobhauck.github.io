    ...
    return (
        <>
            ...
            <tbody>
                ...
                <tr>
                <td></td>
                <td className="pcpp-part-list-price-note">Prices <strong>do not</strong> include shipping, taxes, rebates, and discounts</td>
                <td></td>
                </tr>
                <tr>
                <td></td>
                ...
                <td></td>
                <td className="pcpp-part-list-price-note">Generated by <a href="https://pcpartpicker.com">PCPartPicker</a> 2023-07-13 21:53 EDT-0400</td>
                <td></td>
                </tr>
            </tbody>
            </table>
